...
const RegisterPage: React.FC<RegisterPageProps> = ({ onBack, onGoToLogin }) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">AI智能註冊系統</div>
            </div>
          </div>
        </div>
      </div>
            ...
            {step === 'info' && (
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400">開啟您的智能物流新體驗</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4 text-center">
                    ...
                    <div className="text-sm font-medium text-white">新會員禮</div>
                    <div className="text-xs text-gray-400">NT$100運費券</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4 text-center">
                    <Star className={`w-8 h-8 mx-auto mb-2`} style={{ color: colors.textGradient.includes('orange') ? '#f97316' : '#3b82f6' }} />
                    <div className="text-sm font-medium text-white">VIP服務</div>
                    <div className="text-xs text-gray-400">專屬客服</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4 text-center">
                    <Crown className={`w-8 h-8 mx-auto mb-2`} style={{ color: colors.textGradient.includes('orange') ? '#a855f7' : '#8b5cf6' }} />
                    <div className="text-sm font-medium text-white">AI優先</div>
                    <div className="text-xs text-gray-400">智能推薦</div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="請輸入您的姓名"
                        className={`w-full pl-10 pr-4 py-3 bg-white/10 border rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 transition-all duration-300 ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-white/10 border border-gray-600 rounded-lg focus:ring-2 focus:border-transparent outline-none text-white transition-all duration-300"
                        style={{ 
                          '--focus-ring-color': colors.glowColor
                        } as React.CSSProperties}
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="至少8個字元"
                        className={`w-full pl-10 pr-12 py-3 bg-white/10 border rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 transition-all duration-300 ${
                ...
                <div className="mt-6">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className={`w-full pl-10 pr-4 py-3 bg-white/10 border rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 transition-all duration-300 resize-none ${
                ...
                <div className="mt-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/10 border border-gray-600 rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 transition-all duration-300"
                      style={{ 
                        '--focus-ring-color': colors.glowColor
                      } as React.CSSProperties}
                    />
                ...
                <div className="mt-6">
                  <label className="flex items-start space-x-3 text-sm text-gray-400">
                    <input 
                      type="checkbox" 
                      className={`mt-1 rounded border-gray-600 bg-white/10 text-orange-500 focus:ring-orange-500`}
                      style={{ 
                        '--accent-color': colors.textGradient.includes('orange') ? '#f97316' : '#06b6d4'
                      } as React.CSSProperties}
                    />
                    <span>
                      我已閱讀並同意
                      <a href="#" className={`hover:text-orange-300 transition-colors duration-300 mx-1`}
                        style={{ 
                ...
                <div className="text-center mt-6">
                  <span className="text-gray-400">已經有帳號了？</span>
                  <button 
                    onClick={onGoToLogin}
                    className={`hover:text-orange-300 transition-colors duration-300 ml-1`}
                    style={{ 
                      color: colors.textGradient.includes('orange') ? '#fb923c' : '#22d3ee'
                    }}
                  >
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      maxLength={6}
                      className="w-full px-4 py-3 bg-white/10 border border-gray-600 rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 text-center text-2xl tracking-widest transition-all duration-300"
                      style={{ 
                        '--focus-ring-color': colors.glowColor
                      } as React.CSSProperties}
                    />
                  ...
                  <div className="text-center">
                    {countdown > 0 ? (
                      <span className="text-gray-400">重新發送驗證碼 ({countdown}s)</span>
                    ) : (
                      <button
                        onClick={resendCode}
              ...
              <>
                <div className="text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={onBack}
                      className="w-full bg-white/5 border border-white/10 text-white py-3 rounded-lg font-semibold transition-all duration-300 hover:bg-white/10"
                    >
                      返回首頁
                    </button>
                  </div>
