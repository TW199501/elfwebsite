...
const LoginPageMobile: React.FC<LoginPageMobileProps> = ({ onBack, onGoToRegister }) => {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className={`${colors.cardBg} backdrop-blur-md border-2 ${colors.borderColor} rounded-2xl p-6 shadow-2xl`}>
              ...
              <>
                ...
                <div className={`flex space-x-1 mb-6 ${colors.cardBg} rounded-lg p-1 border ${colors.borderColor}`}>
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-1 py-2 px-2 rounded-md transition-all duration-300 ${
                      loginMethod === 'email' 
            ...
            {step === 'biometric' && (
              <>
                <div className="text-center">
                  <div className={`w-28 h-28 rounded-full flex items-center justify-center mx-auto mb-6 relative transition-all duration-500 ${
                  ...
                  {biometricStatus === 'error' && (
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className={`block mx-auto hover:text-orange-400 transition-colors duration-300 text-sm`}
                        style={{ 
                          color: colors.textGradient.includes('orange') ? '#fb923c' : '#22d3ee'
                        }}
                      >
