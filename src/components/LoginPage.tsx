...
const LoginPage: React.FC<LoginPageProps> = ({ onBack, onGoToRegister }) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">AI智能登入系統</div>
            </div>
          </div>
        </div>
      </div>
            ...
            {step === 'login' && (
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400">啟動您的專屬AI集運服務</p>
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="請輸入您的密碼"
                          className="w-full pl-10 pr-12 py-3 bg-white/10 border border-gray-600 rounded-lg focus:ring-2 focus:border-transparent outline-none text-white placeholder-gray-400 transition-all duration-300"
                          style={{ 
                            '--focus-ring-color': colors.glowColor
                          } as React.CSSProperties}
                        />
                ...
                {loginMethod === 'biometric' && (
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">生物識別登入</h3>
                    <p className="text-gray-400 mb-6">使用指紋或面部識別快速登入</p>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between mb-6 text-sm">
                  <label className="flex items-center space-x-2 text-gray-400">
                    <input type="checkbox" className={`rounded border-gray-600 bg-white/10 text-orange-500 focus:ring-orange-500`} 
                      style={{ 
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="flex items-center justify-center space-x-2 py-3 px-4 bg-white/5 border border-gray-600 rounded-lg hover:bg-white/10 transition-all duration-300">
                  ...
                  {biometricStatus === 'error' && (
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className={`block mx-auto hover:text-orange-300 transition-colors duration-300`}
                        style={{ 
                          color: colors.textGradient.includes('orange') ? '#fb923c' : '#22d3ee'
                        }}
                      >
